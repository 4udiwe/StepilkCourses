    ...
    Column(
        ...
        TextButton(
            ...
            Row (
                ...
                Icon(imageVector = Icons.Default.Clear, contentDescription = "123", tint = colorResource(id = R.color.green))
            }
    ...
    Column(
        ...
        TextButton(
            ...
            Row (
                ...
                Icon(imageVector = Icons.Default.Clear, contentDescription = "123")
            }
...
fun CourseSheet(
    ...
    Card(
        ...
        colors = CardDefaults.cardColors(containerColor = colorResource(id = R.color.elements), contentColor = Color.White)
    ) {
        Column(
            modifier = Modifier.fillMaxWidth()
        ) {
                    ...
                    Row(
                        ...
                        Card(
                            ...
                            Row(
                                ...
                                Text(
                                    text = "${pubDate?.substring(8, 10)} $month ${pubDate?.take(4)}",
                                    color = Color.White
                                )
                            }
                        }
            ...
            Column(
                ...
                Row(
                    ...
                    TextButton(
                        ...
                        colors = ButtonDefaults.buttonColors(contentColor = colorResource(id = R.color.green), containerColor = Color.Transparent)
                    ) {
                        Text(text = "Подробнее")
                        Icon(
